...
//-----------------------Variable END---------------------------------
		...
		//;CX588_SOUND.C: 76: if(TMR2IE && TMR2IF)
		...
		//;CX588_SOUND.C: 77: {
		//;CX588_SOUND.C: 78: TMR2IF = 0;
		BCR 	CH,1 			//007F 	108C

		//;CX588_SOUND.C: 80: if(TIME_OUT < 0xff)
		LCALL 	9FH 			//0080 	309F
		...
		//;CX588_SOUND.C: 82: }
		//;CX588_SOUND.C: 85: if(PAIE && PAIF)
		BTSC 	INTCON,3 		//008B 	158B
		BTSS 	INTCON,0 		//008C 	1C0B
		LJUMP 	95H 			//008D 	3895

		//;CX588_SOUND.C: 86: {
		//;CX588_SOUND.C: 87: ReadAPin = PORTA;
		BCR 	STATUS,5 		//008E 	1283
		LDR 	5H,0 			//008F 	0805

		//;CX588_SOUND.C: 88: PAIF = 0;
		BCR 	INTCON,0 		//0090 	100B

		//;CX588_SOUND.C: 89: PAIE = 0;
		BCR 	INTCON,3 		//0091 	118B

		//;CX588_SOUND.C: 90: IOCA2 =0;
		BSR 	STATUS,5 		//0092 	1A83
		BCR 	16H,2 			//0093 	1116

		//;CX588_SOUND.C: 91: GIE = 1;
		...
		//;CX588_SOUND.C: 19: if(CX588_Get_Busy_State() == 1)
		...
		//;CX588_SOUND.C: 20: {
		//;CX588_SOUND.C: 21: TMR2IE = 1;
		BSR 	STATUS,5 		//00A9 	1A83
		BSR 	CH,1 			//00AA 	188C

		//;CX588_SOUND.C: 22: PEIE=1;
		BSR 	INTCON,6 		//00AB 	1B0B

		//;CX588_SOUND.C: 23: GIE = 1;
		BSR 	INTCON,7 		//00AC 	1B8B

		//;CX588_SOUND.C: 24: if(TIME_OUT > 5)
		...
		//;CX588_SOUND.C: 25: {
		//;CX588_SOUND.C: 26: TIME_OUT = 0;
		BCR 	STATUS,5 		//00B5 	1283

		//;CX588_SOUND.C: 27: TMR2IE = 0;
		//;CX588_SOUND.C: 28: PEIE = 0;
		//;CX588_SOUND.C: 29: GIE = 0;
		LCALL 	BDH 			//00B6 	30BD

		//;CX588_SOUND.C: 31: PA2_Level_Change_INITIAL();
		LCALL 	166H 			//00B7 	3166
		SLEEP	 			//00B8 	0002

		//;CX588_SOUND.C: 33: __nop();
		NOP		 					//00B9 	0000
		RET		 					//00BA 	0004

		//;CX588_SOUND.C: 36: else
		//;CX588_SOUND.C: 37: {
		//;CX588_SOUND.C: 38: TIME_OUT = 0;
		//;CX588_SOUND.C: 39: TMR2IE = 0;
		//;CX588_SOUND.C: 40: PEIE = 0;
		//;CX588_SOUND.C: 41: GIE = 0;
		LCALL 	BDH 			//00BB 	30BD
		RET		 					//00BC 	0004
		CLRR 	4EH 			//00BD 	014E
		CLRR 	4FH 			//00BE 	014F
		...
		//;CX588_SOUND.C: 53: if(PA2 == 0)
		BTSC 	5H,2 			//00DA 	1505
		RET		 					//00DB 	0004

		//;CX588_SOUND.C: 54: {
		//;CX588_SOUND.C: 55: DelayMs(20);
		LDWI 	14H 			//00DC 	2A14
		LCALL 	113H 			//00DD 	3113

		//;CX588_SOUND.C: 56: if(PA2 == 0)
		BCR 	STATUS,5 		//00DE 	1283
		BTSC 	5H,2 			//00DF 	1505
		RET		 					//00E0 	0004

		//;CX588_SOUND.C: 57: {
		//;CX588_SOUND.C: 58: if(CX588_Get_Busy_State())
		...
		//;CX588_SOUND.C: 59: {
		//;CX588_SOUND.C: 60: CX588_Play_Sound((rand()%8)+1);
		LCALL 	4CH 			//00E5 	304C
		LDR 	48H,0 			//00E6 	0848
		ANDWI 	7H 			//00E7 	2407
		ADDWI 	1H 			//00E8 	2701
		...
		//;CX588_SOUND.C: 118: T2CON0 = 0B01001011;
		LDWI 	4BH 			//0101 	2A4B
		BCR 	STATUS,5 		//0102 	1283
		STR 	12H 			//0103 	0192

		//;CX588_SOUND.C: 122: T2CON1 = 0B00001000;
		LDWI 	8H 			//0104 	2A08
		BSR 	STATUS,5 		//0105 	1A83
		STR 	1EH 			//0106 	019E

		//;CX588_SOUND.C: 123: TMR2H = 0;
		BCR 	STATUS,5 		//0107 	1283
		CLRR 	13H 			//0108 	0113

		//;CX588_SOUND.C: 124: TMR2L = 0;
		CLRR 	11H 			//0109 	0111

		//;CX588_SOUND.C: 125: PR2H = 100;
		LDWI 	64H 			//010A 	2A64
		BSR 	STATUS,5 		//010B 	1A83
		STR 	12H 			//010C 	0192

		//;CX588_SOUND.C: 126: PR2L = 250;
		LDWI 	FAH 			//010D 	2AFA
		STR 	11H 			//010E 	0191

		//;CX588_SOUND.C: 128: TMR2IF = 0;
		BCR 	STATUS,5 		//010F 	1283
		BCR 	CH,1 			//0110 	108C

		//;CX588_SOUND.C: 129: TMR2ON = 1;
		BSR 	12H,2 			//0111 	1912
		RET		 					//0112 	0004
		STR 	75H 			//0113 	01F5
		...
		//;CX588_SOUND.C: 140: OSCCON = 0B01110001;
		LDWI 	71H 			//0123 	2A71
		BSR 	STATUS,5 		//0124 	1A83
		STR 	FH 			//0125 	018F

		//;CX588_SOUND.C: 141: INTCON = 0;
		CLRR 	INTCON 			//0126 	010B

		//;CX588_SOUND.C: 143: OPTION = 0;
		CLRR 	1H 			//0127 	0101

		//;CX588_SOUND.C: 144: TRISA = 0B00000100;
		LDWI 	4H 			//0128 	2A04
		STR 	5H 			//0129 	0185

		//;CX588_SOUND.C: 145: PSRCA = 0;
		CLRR 	8H 			//012A 	0108

		//;CX588_SOUND.C: 146: PSINKA = 0;
		CLRR 	17H 			//012B 	0117

		//;CX588_SOUND.C: 147: PORTA = 0B00000000;
		BCR 	STATUS,5 		//012C 	1283
		CLRR 	5H 			//012D 	0105

		//;CX588_SOUND.C: 148: WPUA = 0B00000100;
		BSR 	STATUS,5 		//012E 	1A83
		STR 	15H 			//012F 	0195
		RET		 					//0130 	0004

		//;CX588_SOUND.C: 158: POWER_INITIAL();
		LCALL 	123H 			//0131 	3123

		//;CX588_SOUND.C: 159: TIMER2_INITIAL();
		LCALL 	101H 			//0132 	3101

		//;CX588_SOUND.C: 160: CX588_GPIO_Init();
		LCALL 	14BH 			//0133 	314B

		//;CX588_SOUND.C: 161: CX588_SET_Sound_Size(SoundLeve_10);
		LDWI 	EAH 			//0134 	2AEA
		...
		//;CX588_SOUND.C: 165: {
		//;CX588_SOUND.C: 166: Play_Sound();
		//;CX588_SOUND.C: 164: while(1)
		LCALL 	DAH 			//013B 	30DA

		//;CX588_SOUND.C: 167: TIME_OUT_Enter_Sleep();
		LCALL 	A5H 			//013C 	30A5
		...
		//;CX588_SOUND.C: 168: srand(Seed_Val);
		LDR 	73H,0 			//015E 	0873
		...
		//;CX588_SOUND.C: 103: TRISA2 = 1;
		BSR 	5H,2 			//0166 	1905

		//;CX588_SOUND.C: 104: ReadAPin = PORTA;
		BCR 	STATUS,5 		//0167 	1283
		LDR 	5H,0 			//0168 	0805

		//;CX588_SOUND.C: 105: PAIF = 0;
		BCR 	INTCON,0 		//0169 	100B

		//;CX588_SOUND.C: 106: IOCA2 = 1;
		BSR 	STATUS,5 		//016A 	1A83
		BSR 	16H,2 			//016B 	1916

		//;CX588_SOUND.C: 107: PAIE = 1;
